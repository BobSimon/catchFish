 ...
 * @Author: Bob Simon
 * @Description: 布局管理器
 * @Date: Created in 11:50 2018\5\3
 */
public class LayoutManager {
	...
	public void init(){
		try {
			...
			addButton(upCannon,bottom.getLayoutX()+bottom.getPicWidth(),GamingInfo.getGamingInfo().getScreenHeight()-upCannon.getPicHeight());
			...
			addButton(downCannon,bottom.getLayoutX()-downCannon.getPicWidth(),GamingInfo.getGamingInfo().getScreenHeight()-downCannon.getPicHeight());
